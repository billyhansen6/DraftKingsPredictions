...
COPY playerstats16_17 FROM '/Users/sauce/Desktop/DraftKings/PlayerStats/playerstats_16_17.csv' DELIMITER ',' CSV HEADER;
COPY playerstats17_18 FROM '/Users/sauce/Desktop/DraftKings/PlayerStats/playerstats_17_18.csv' DELIMITER ',' CSV HEADER;
...
COPY TeamStats_17_18 FROM '/Users/sauce/Desktop/DraftKings/TeamStats/team_stats_17_18.csv' DELIMITER ',' CSV HEADER;
COPY TeamStats_16_17 FROM '/Users/sauce/Desktop/DraftKings/TeamStats/team_stats_16_17.csv' DELIMITER ',' CSV HEADER;
...
-- Copy Opponnets Data
COPY Opponents_17_18 FROM '/Users/sauce/Desktop/DraftKings/TeamStats/team_stats_17_18.csv' DELIMITER ',' CSV HEADER;
COPY Opponents_16_17 FROM '/Users/sauce/Desktop/DraftKings/TeamStats/team_stats_16_17.csv' DELIMITER ',' CSV HEADER;
...
COPY DraftKings_16_17 FROM '/Users/sauce/Desktop/DraftKings/DKStats/dk_16_17.csv' DELIMITER ',' CSV HEADER;
COPY DraftKings_17_18 FROM '/Users/sauce/Desktop/DraftKings/DKStats/dk_17_18.csv' DELIMITER ',' CSV HEADER;
...
-- Copy in Rest Data
COPY rest_16_17 FROM '/Users/sauce/Desktop/DraftKings/Rest/BS_16_17.csv' DELIMITER ',' CSV HEADER;
COPY rest_17_18 FROM '/Users/sauce/Desktop/DraftKings/Rest/BS_17_18.csv' DELIMITER ',' CSV HEADER;
...
-- Create Stats for Avg Vs. Each Opponent
DROP TABLE IF EXISTS avg_points_vs_opp;
select season, player, round(avg(fantasy_points), 2) as avg_points_vs_opp, opponent 
into avg_points_vs_opp 
from draftkings_combined
group by player, opponent, season
;

-- Create Avg. Points Opponent gives up per position.
drop table if exists opp_pos_avg;
select season, opponent, position, round(avg(fantasy_points), 2) as opp_pos_avg
into opp_pos_avg
from draft_kings_combined
group by season, opponent, position;
